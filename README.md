...
Este repositório contém o **backend** e **frontend** do sistema Tecnico, desenvolvido como API RESTful com Spring Boot. O sistema é dividido em duas partes independentes que se comunicam via HTTP:
